...
export default function CustomerMessages() {
  ...
  const activeAgent = conversations.find(c => c.id === activeChatId);
            ...
            >
              <div className="flex items-center gap-3">
                <div className="relative shrink-0">
                  <img src={chat.avatar} alt={chat.agentName} className="w-12 h-12 rounded-full object-cover" />
                  {chat.online && (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-0.5">
                    <h4 className="font-semibold text-gray-900 truncate">{chat.agentName}</h4>
      ...
      {activeAgent ? (
        <div className="flex-1 flex flex-col bg-white">
          ...
          <div className="h-16 px-6 border-b border-gray-100 flex justify-between items-center shrink-0">
            <div className="flex items-center gap-3">
              <img src={activeAgent.avatar} alt={activeAgent.agentName} className="w-10 h-10 rounded-full object-cover" />
              <div>
                <h3 className="font-bold text-gray-900">{activeAgent.agentName}</h3>
                <p className="text-xs text-gray-500">{activeAgent.online ? 'Online' : 'Offline'}</p>
              </div>
            </div>
